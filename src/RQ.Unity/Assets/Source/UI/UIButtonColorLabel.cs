...
{
    [ExecuteInEditMode]
    [AddComponentMenu("RQ/UI/Button Color Label")]
    public class UIButtonColorLabel : MonoBehaviour
    {
        public enum State
        {
            Normal,
        ...
        public Color hoverEffect = new Color(225f / 255f, 200f / 255f, 150f / 255f, 1f);
        public Color normalEffect = new Color(1f, 1f, 1f, 1f);
        ...
        public void UpdateColor(bool instant)
        {
            ...
            if (tweenTarget != null)
            {
                var label = tweenTarget.GetComponent<UILabel>();
                Color newEffectColor;
                switch (mState)
                {
                    case State.Hover: newEffectColor = hoverEffect; break;
                    default: newEffectColor = normalEffect; break;
                }

                label.effectColor = newEffectColor;
    ...
    //    [AddComponentMenu("RQ/UI/Button Color Label")]
    //    [ExecuteInEditMode]
    //    public class UIButtonColorLabel : UIButtonColor
    //    {
    //        public Color hoverEffect = new Color(225f / 255f, 200f / 255f, 150f / 255f, 1f);
    //        public Color normalEffect = new Color(1f, 1f, 1f, 1f);
    ...
    //        public void UpdateHoverColor(bool instant)
    //        {
    //            if (tweenTarget == null)
    //                return;
