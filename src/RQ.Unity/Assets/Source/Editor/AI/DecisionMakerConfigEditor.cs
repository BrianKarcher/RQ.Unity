...
{
    [CustomEditor(typeof(DecisionMakerAsset), true)]
    public class DecisionMakerConfigEditor : EditorBase
    {

        [MenuItem("Assets/Create/RQ/DM Config")]
        public static void CreateNewAsset()
        {
            CreateAsset<DecisionMakerAsset>("NewDM.asset");
