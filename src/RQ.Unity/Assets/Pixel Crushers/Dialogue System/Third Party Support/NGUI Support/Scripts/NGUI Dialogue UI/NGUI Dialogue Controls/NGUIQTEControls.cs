...
namespace PixelCrushers.DialogueSystem.NGUISupport
{
    ...
    public class NGUIQTEControls : AbstractUIQTEControls
    {
        ...
        /// </summary>
        public global::UIPanel[] qteIndicators;

        private int numVisibleQTEIndicators = 0;

        public NGUIQTEControls(global::UIPanel[] qteIndicators)
        {
        ...
        public override void SetActive(bool value)
        {
            if (value == false)
            {
                ...
                {
                    if (qteIndicator != null && qteIndicator.gameObject != null) NGUIDialogueUIControls.SetControlActive(qteIndicator.gameObject, false);
                }
            }
        }
