...
Shader "Custom/LitUVScroll Blend Vertex Color"
{
	Properties
	{
...
#line 24 ""
					...
					fixed4 frag_surf(v2f_surf IN) : SV_Target{
						...
						spriteUV.x = spriteUV.x + (_Velocity.x * _Time.y);
						spriteUV.y = spriteUV.y + (_Velocity.y * _Time.y);


						surfIN.uv_MainTex = spriteUV.xy;
