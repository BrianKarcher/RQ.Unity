...
float OverlaySingle(float base, float top)
{
     if (base < 0.5){
          return 2 * base*top;
     }
...
float4 Overlay2(float4 a, float4 b) {
	fixed4 col = fixed4(0, 0, 0, 0);
	col.r = OverlaySingle(a.r, b.r);
	col.g = OverlaySingle(a.g, b.g);
	col.b = OverlaySingle(a.b, b.b);
	col.a = b.a;
	return col;
}
